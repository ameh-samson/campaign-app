...
export default function SideNavbar() {
  return (
    <nav className="w-[22%] bg-[#f0f4f4] fixed p-8">
      ...
      <div className="bg-white p-7 mt-10 flex flex-col items-center justify-center">
        ...
        <button className="text-[#247b7b] rounded border border-[#247b7b] bg-transparent">
          Get help
        </button>
      </div>
    </nav>
